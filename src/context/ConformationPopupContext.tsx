...
export const ConformationPopupProvider = ({children}: any) => {
    ...
    const setConformationPopup = useCallback(({
                                                  icon,
                                                  title,
                                                  message,
                                                  popupType,
    ...
    const clearConfirmationPopupState = useCallback(() => {  // Remove the parameter from this function
    ...
    return (
        <ConformationPopupContext.Provider
            value={{
                ...
                onClickPrimary,
                show,
                setConformationPopup, clearConfirmationPopupState,
            }}
        >
            {children}
        </ConformationPopupContext.Provider>
