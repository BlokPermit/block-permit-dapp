                        ...
                        <div className=" pb-2">
                            <div className="flex justify-between   pb-0">
                                <div>
                                    ...
                                    <p className="mt-1 text-sm leading-6 text-gray-600">Add required investors to your
                                        project.</p>
                                </div>
                                <div className="flex ">
                                    ...
                                    <div className="">
                                        <OutlineButton text={"Add Investor"} onClick={handleAddInvestor}
                            ...
                            {addedInvestors.map((user, i) => (
                                <div key={i}
                                     className={`border-b ${i == 0 ? "border-t" : null} border-gray-900/10 py-5`}>
