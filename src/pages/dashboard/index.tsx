...
import DocumentPlaceholder from "@/components/generic/placeholders/DocumentPlaceholder";
    ...
    return (
        ...
        <div className="mt-10">
          <div className="flex items-center">
            ...
            <span className="inline-flex items-center justify-center rounded-full bg-amber-100 px-2.5 py-0.5 text-amber-700  h-1/4 mt-0.5">
