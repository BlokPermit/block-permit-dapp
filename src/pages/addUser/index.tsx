...
const options: Option[] = [
    ...
    {
        value: UserType.OPINION_PROVIDER,
...
const UserTypeDisplay = {
    ...
    [UserType.OPINION_PROVIDER]: 'Opinion Provider',
            ...
            <div className="border-b border-gray-900/10 py-10  ">
                <div className="flex w-full ">
                    ...
                    <div className="w-1/2 px-5 space-y-2">
                        ...
                        <InputField id={"walletAddress"} name={"walletAddress"}
                                    label={"Wallet address"}
                                    placeholder={"0xBB39C4ac246cF3e10828..."}
                                    onChange={handleInputChange}
                                    type={"text"} value={userForm.walletAddress}/>
