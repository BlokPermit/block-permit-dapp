                                ...
                                <div className="flex items-center justify-center space-x-1">
                                    ...
                                    <Link href={`/user/editUser/${user?.id}`}>
                                        <IconButton
                                            ...
                                            icon={<FaEdit/>} text={"Uredi"} onClick={() => {
                                        }}/>
                                    </Link>
                                </div>
                                <div className="flex items-center">
                            <span
                                className={`inline-flex items-center justify-center rounded-full bg-main-400 px-2.5 py-1  text-white  h-3/4 mr-2.5`}>
                                 <FaUser color="white" size={14}/>
                                  <p className="whitespace-nowrap text-sm pl-1.5 ">{getUserType(user?.userType)}</p>
                        </span>

                                        <MdLogout size={25} onClick={handleSignout} className="cursor-pointer"/>
